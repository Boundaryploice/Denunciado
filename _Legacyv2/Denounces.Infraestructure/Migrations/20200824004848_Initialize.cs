        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposalTypeId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Proposals_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_AspNetUsers_DeletedBy",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_Provinces_ProvinceId",
                        column: x => x.ProvinceId,
                        principalTable: "Provinces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Proposals_AspNetUsers_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProposalFiles_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProposalFiles_AspNetUsers_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProposalFiles_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedAt = table.Column<DateTime>(nullable: true),
                    DeletedBy = table.Column<string>(nullable: true),
                    IsFavorVote = table.Column<bool>(nullable: false),
                    IsNegativeVote = table.Column<bool>(nullable: false),
                    IsNullVote = table.Column<bool>(nullable: false),
                    ProposalId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Votes_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Votes_AspNetUsers_DeletedBy",
                        column: x => x.DeletedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Votes_AspNetUsers_UpdatedBy",
                        column: x => x.UpdatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "Denomym", "Name" },
                values: new object[,]
                {
                    { 1L, "Dominicans", "Dominican Republic" },
                    { 2L, "Haitian", "Haiti" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "Proposal", null, "Proposal" },
                    { 2L, "Denounce", null, "Denounce" }
                });

            migrationBuilder.InsertData(
                table: "Status",
                columns: new[] { "Id", "Name", "Table" },
                values: new object[,]
                {
                    { 1L, "Active", "Proposal" },
                    { 2L, "Closed", "Proposal" },
                    { 3L, "Rejected", "Proposal" },
                    { 4L, "Promoted", "Proposal" },
                    { 5L, "Applied", "Proposal" }
                });

            migrationBuilder.InsertData(
                table: "Provinces",
                columns: new[] { "Id", "CountryId", "Initials", "Name" },
                values: new object[] { 1L, 1L, "SD", "Santo Domingo" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProposalFiles_CreatedBy",
                table: "ProposalFiles",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ProposalFiles_DeletedBy",
                table: "ProposalFiles",
                column: "DeletedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProposalFiles_UpdatedBy",
                table: "ProposalFiles",
                column: "UpdatedBy");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Votes_CreatedBy",
                table: "Votes",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_Votes_DeletedBy",
                table: "Votes",
                column: "DeletedBy");
